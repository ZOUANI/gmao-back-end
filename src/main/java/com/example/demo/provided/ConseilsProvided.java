...
public class ConseilsProvided {
    ...
    public List<Conseils> findByEquipeRef(@PathVariable String ref) {
    ...
    public List<Conseils> findByEquipeRefAndCollaborateurcodeCollaborateur(@PathVariable String ref,@PathVariable  String code) {
